...
ggsave("figures/bootstrap_1.jpeg", plot = limit_plot,
       device = "jpeg", width = 6, height = 6, units = "in", dpi = 500)

ggsave("figures/bootstrap_2.jpeg", plot = histogram_plot,
       device = "jpeg", width = 6, height = 6, units = "in", dpi = 500)

ggsave("figures/bootstrap_3.jpeg", plot = violin_plot,
       device = "jpeg", width = 6, height = 6, units = "in", dpi = 500)

ggsave("figures/bootstrap_4.jpeg", plot = simulation_plot,
       device = "jpeg", width = 6, height = 6, units = "in", dpi = 500)